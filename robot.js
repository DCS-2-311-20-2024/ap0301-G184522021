...
armR.position.x = -(bodyW/2 + armRad);
metalRobot.add(armR);
  //  頭の作成
...
cardboardRobot.add(legL);
  ...
  armL.position.set(bodyW/2 + armW/2, legLen + bodyH - armLen/2);
  ...
  armR.position.set(bodyW/2 + armW/2, legLen + bodyH - armLen/2);
  armR.position.x = -(bodyW/2 + armW);
